...
class morpion:
    ...
    def tour_bot(self, ligne, colonne, player,tour):
        ...
        if tour == 3:
            ...
            if ligne == 1 and colonne == 2:
                ...
                if self.tableau[1][2]=='X' and self.tableau[2][2]=='X':
                    self.tableau[0][0]=player
                if self.tableau[2][0]=='X' and self.tableau[0][2]=='X':
                    self.tableau[1][2]=player
                if self.tableau[2][0]=='X' and self.tableau[1][1]=='X':
                    self.tableau[1][2]=player
                if self.tableau[2][0]=='X' and self.tableau[2][1]=='X':
        ...
        if tour == 4:
            ...
            if ligne == 3 and colonne == 1:
                ...
                if self.tableau[0][0]=='X' and self.tableau[2][1]=='X' and self.tableau[1][1]=='X':
                    self.tableau[1][2]=player
                if self.tableau[0][1]=='X' and self.tableau[0][0]=='X' and self.tableau[1][1]=='X':
                    self.tableau[1][2]=player
                if self.tableau[0][1]=='X' and self.tableau[0][0]=='X' and self.tableau[2][1]=='X':
                    self.tableau[1][0]=player
                if self.tableau[0][1]=='X' and self.tableau[0][0]=='X' and self.tableau[2][1]=='X':
                    self.tableau[1][2]=player
                if self.tableau[0][1]=='X' and self.tableau[0][2]=='X' and self.tableau[2][2]=='X':
                    self.tableau[1][0]=player
                if self.tableau[0][1]=='X' and self.tableau[0][2]=='X' and self.tableau[2][2]=='X':
                    self.tableau[1][0]=player
                if self.tableau[0][1]=='X' and self.tableau[1][0]=='X' and self.tableau[1][1]=='X':
                ...
                if self.tableau[0][1]=='X' and self.tableau[1][2]=='X' and self.tableau[2][2]=='X':
                    self.tableau[2][1]=player
                if self.tableau[0][2]=='X' and self.tableau[0][0]=='X' and self.tableau[1][2]=='X':
                    self.tableau[2][1]=player
                if self.tableau[0][2]=='X' and self.tableau[0][0]=='X' and self.tableau[2][1]=='X':
                    self.tableau[1][0]=player
                if self.tableau[0][2]=='X' and self.tableau[0][1]=='X' and self.tableau[2][2]=='X':
                    self.tableau[1][0]=player
                if self.tableau[0][2]=='X' and self.tableau[1][0]=='X' and self.tableau[2][2]=='X':
                    self.tableau[2][1]=player
                if self.tableau[1][0]=='X' and self.tableau[0][1]=='X' and self.tableau[1][1]=='X':
                    self.tableau[2][2]=player
                if self.tableau[1][0]=='X' and self.tableau[0][1]=='X' and self.tableau[2][2]=='X':
                    self.tableau[2][1]=player
                if self.tableau[1][0]=='X' and self.tableau[0][2]=='X' and self.tableau[2][2]=='X':
                    self.tableau[2][1]=player
                if self.tableau[1][0]=='X' and self.tableau[2][2]=='X' and self.tableau[1][1]=='X':
                    self.tableau[0][1]=player
                if self.tableau[1][2]=='X' and self.tableau[0][0]=='X' and self.tableau[0][2]=='X':
                    self.tableau[2][1]=player
                if self.tableau[1][2]=='X' and self.tableau[0][0]=='X' and self.tableau[1][1]=='X':
                    self.tableau[0][1]=player
                if self.tableau[1][1]=='X' and self.tableau[0][1]=='X' and self.tableau[1][2]=='X':
                    self.tableau[1][0]=player
                if self.tableau[1][2]=='X' and self.tableau[1][0]=='X' and self.tableau[2][2]=='X':
                    self.tableau[1][0]=player
                if self.tableau[1][2]=='X' and self.tableau[2][1]=='X' and self.tableau[1][1]=='X':
                    self.tableau[0][0]=player
                if self.tableau[1][2]=='X' and self.tableau[2][2]=='X' and self.tableau[1][1]=='X':
                    self.tableau[0][1]=player
                if self.tableau[2][1]=='X' and self.tableau[0][0]=='X' and self.tableau[0][2]=='X':
                    self.tableau[1][2]=player
                if self.tableau[2][1]=='X' and self.tableau[0][0]=='X' and self.tableau[1][1]=='X':
                    self.tableau[1][2]=player
                if self.tableau[2][1]=='X' and self.tableau[1][2]=='X' and self.tableau[1][1]=='X':
                    self.tableau[0][0]=player
                if self.tableau[2][2]=='X' and self.tableau[1][0]=='X' and self.tableau[0][0]=='X':
                    self.tableau[0][2]=player
                if self.tableau[2][2]=='X' and self.tableau[0][1]=='X' and self.tableau[0][2]=='X':
                    self.tableau[1][0]=player
                if self.tableau[2][2]=='X' and self.tableau[0][1]=='X' and self.tableau[1][1]=='X':
                    self.tableau[0][1]=player
                if self.tableau[2][2]=='X' and self.tableau[0][2]=='X' and self.tableau[1][0]=='X':
                    self.tableau[2][1]=player
                if self.tableau[2][2]=='X' and self.tableau[1][0]=='X' and self.tableau[2][2]=='X':
                    self.tableau[0][1]=player
                if self.tableau[1][2]=='X' and self.tableau[1][0]=='X' and self.tableau[2][2]=='X':
                    self.tableau[0][1]=player
                if self.tableau[1][1]=='X' and self.tableau[1][0]=='X' and self.tableau[2][2]=='X':
                    self.tableau[0][1]=player
            if ligne == 3 and colonne == 2:
                if self.tableau[0][0]=='X' and self.tableau[0][1]=='X' and self.tableau[1][2]=='X':
                    self.tableau[2][0]=player
                ...
                if self.tableau[0][0]=='X' and self.tableau[1][0]=='X' and self.tableau[1][2]=='X':
                    self.tableau[0][2]=player
                if self.tableau[0][0]=='X' and self.tableau[1][2]=='X' and self.tableau[0][0]=='X':
                    self.tableau[2][0]=player
                if self.tableau[0][0]=='X' and self.tableau[1][2]=='X' and self.tableau[2][0]=='X':
                    self.tableau[2][2]=player
                if self.tableau[0][0]=='X' and self.tableau[1][2]=='X' and self.tableau[2][2]=='X':
                    self.tableau[0][2]=player
                if self.tableau[0][1]=='X' and self.tableau[0][0]=='X' and self.tableau[1][2]=='X':
                    self.tableau[2][0]=player
                if self.tableau[0][1]=='X' and self.tableau[0][0]=='X' and self.tableau[2][0]=='X':
                    self.tableau[1][0]=player
                if self.tableau[0][1]=='X' and self.tableau[0][2]=='X' and self.tableau[1][0]=='X':
                    self.tableau[0][2]=player
                if self.tableau[0][1]=='X' and self.tableau[0][2]=='X' and self.tableau[2][2]=='X':
                ...
                if self.tableau[0][2]=='X' and self.tableau[1][0]=='X' and self.tableau[2][2]=='X':
                    self.tableau[2][0]=player
                if self.tableau[1][0]=='X' and self.tableau[0][0]=='X' and self.tableau[1][0]=='X':
                    self.tableau[2][1]=player
                if self.tableau[1][0]=='X' and self.tableau[0][1]=='X' and self.tableau[0][2]=='X':
                    self.tableau[2][0]=player
                if self.tableau[1][0]=='X' and self.tableau[0][1]=='X' and self.tableau[1][2]=='X':
                    self.tableau[0][2]=player
                if self.tableau[1][0]=='X' and self.tableau[0][1]=='X' and self.tableau[2][0]=='X':
                    self.tableau[2][0]=player
                if self.tableau[1][0]=='X' and self.tableau[0][1]=='X' and self.tableau[2][2]=='X':
                    self.tableau[0][2]=player
                if self.tableau[1][0]=='X' and self.tableau[0][0]=='X' and self.tableau[1][2]=='X':
                    self.tableau[0][0]=player
                if self.tableau[1][0]=='X' and self.tableau[0][2]=='X' and self.tableau[2][2]=='X':
                    self.tableau[0][0]=player
                if self.tableau[1][0]=='X' and self.tableau[1][2]=='X' and self.tableau[2][0]=='X':
                ...
                if self.tableau[1][0]=='X' and self.tableau[2][2]=='X' and self.tableau[1][1]=='X':
                    self.tableau[0][1]=player
                if self.tableau[1][2]=='X' and self.tableau[0][1]=='X' and self.tableau[0][0]=='X':
                    self.tableau[2][0]=player
                if self.tableau[1][2]=='X' and self.tableau[0][0]=='X' and self.tableau[1][0]=='X':
                    self.tableau[0][2]=player
                if self.tableau[1][2]=='X' and self.tableau[0][0]=='X' and self.tableau[1][1]=='X':
                    self.tableau[0][1]=player
                if self.tableau[1][2]=='X' and self.tableau[0][0]=='X' and self.tableau[2][0]=='X':
                    self.tableau[2][1]=player
                if self.tableau[1][2]=='X' and self.tableau[0][1]=='X' and self.tableau[2][0]=='X':
                    self.tableau[2][2]=player
                if self.tableau[1][2]=='X' and self.tableau[0][1]=='X' and self.tableau[2][2]=='X':
                    self.tableau[2][0]=player
                if self.tableau[1][2]=='X' and self.tableau[0][2]=='X' and self.tableau[1][0]=='X':
                    self.tableau[0][0]=player
                if self.tableau[1][2]=='X' and self.tableau[0][2]=='X' and self.tableau[2][0]=='X':
                    self.tableau[0][0]=player
                if self.tableau[1][2]=='X' and self.tableau[1][0]=='X' and self.tableau[2][0]=='X':
                    self.tableau[2][2]=player
                if self.tableau[1][2]=='X' and self.tableau[2][0]=='X' and self.tableau[1][1]=='X':
                    self.tableau[0][0]=player
                if self.tableau[1][2]=='X' and self.tableau[2][0]=='X' and self.tableau[2][2]=='X':
                ...
                if self.tableau[1][2]=='X' and self.tableau[2][2]=='X' and self.tableau[1][1]=='X':
                    self.tableau[0][1]=player
                if self.tableau[20][0]=='X' and self.tableau[0][0]=='X' and self.tableau[0][1]=='X':
                    self.tableau[1][2]=player
                if self.tableau[2][0]=='X' and self.tableau[0][0]=='X' and self.tableau[1][2]=='X':
                    self.tableau[0][2]=player
                if self.tableau[2][0]=='X' and self.tableau[0][1]=='X' and self.tableau[1][2]=='X':
                    self.tableau[0][0]=player
                if self.tableau[2][0]=='X' and self.tableau[1][2]=='X' and self.tableau[1][1]=='X':
                    self.tableau[0][1]=player
                if self.tableau[2][2]=='X' and self.tableau[0][1]=='X' and self.tableau[0][2]=='X':
                    self.tableau[1][0]=player
                if self.tableau[2][2]=='X' and self.tableau[0][1]=='X' and self.tableau[1][0]=='X':
                    self.tableau[0][2]=player
                if self.tableau[2][2]=='X' and self.tableau[0][1]=='X' and self.tableau[1][2]=='X':
                    self.tableau[2][0]=player
                if self.tableau[2][2]=='X' and self.tableau[0][2]=='X' and self.tableau[1][0]=='X':
                    self.tableau[0][1]=player
                if self.tableau[2][2]=='X' and self.tableau[1][0]=='X' and self.tableau[1][1]=='X':
                    self.tableau[0][1]=player
                if self.tableau[2][2]=='X' and self.tableau[1][0]=='X' and self.tableau[1][2]=='X':
                    self.tableau[0][2]=player
                if self.tableau[2][2]=='X' and self.tableau[1][2]=='X' and self.tableau[1][1]=='X':
                    self.tableau[0][1]=player
            if ligne == 3 and colonne == 3:
                if self.tableau[0][0]=='X' and self.tableau[0][1]=='X' and self.tableau[2][0]=='X':
                    self.tableau[1][2]=player
    ...
    def start(self):
        ...
        while True:
            ...
            tour=tour+1
            if self.victoire_joueur('X'):
                print("Joueur X à gagné le match!")
                break
            elif self.victoire_joueur('O') and roll==1:
                print('  ╭┻━━┻╮\n ╭┫^  ^┣╮\n ╰┓┳╰╯┳┏╯ For You\n ╭┛╰━━╯┗━━━╮\n ┃┃    ┏━╭╰╯━╮\n ┃┃    ┃┏┻━━━┻┓\n ╰┫ ╭╮ ┃┃RATIO┃\n  ┃ ┃┃ ┃╰━━━━━╯')
                break
            elif self.victoire_joueur('O') and roll==2:
                print('╭━━━━━╮\n╰┃ ┣▇━▇\n ┃ ┃  ╰━▅╮\n ╰┳╯ ╰━━┳╯ BRUV KEK😎\n  ╰╮ ┳━━╯ SUPER EASY🤙\n ▕▔▋ ╰╮╭━╮NICE TUTORIAL😂\n╱▔╲▋╰━┻┻╮╲╱▔▔▔╲\n▏  ▔▔▔▔▔▔▔  O O┃\n╲╱▔╲▂▂▂▂╱▔╲▂▂▂╱\n ▏╳▕▇▇▕ ▏╳▕▇▇▕\n ╲▂╱╲▂╱ ╲▂╱\n')
                break
            ...
            if self.tableau_remplit():
                if roll==1:
                    print("TRY AGAIN LOL (YOU WILL NEVER WIN)!")
                    break
                else:
                    print("YOU THOUGHT U COULD BEAT A BOT...HOW STUPID !")
                    break
